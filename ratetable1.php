...
<body>
<h2>Rate Table</h2>
<div style="width: 49%; height: 50%; background-color: lightgrey; float: right">
    ...
    <div style="width: 50%; height: 50%; background-color: lightgrey; float:left; margin-top: 10px;"><h3 align="center">Weight</h3>
            <table align="center">
           ...
           <tr><td>20Kg & Above:</td><td></td><td> &#x20B9;1500</td></tr>
            ...
            <div style="width: 49%; height: 237px; background-color: grey; float:right; margin-top: 10px;">
            	<div style="margin-left: 10px; margin-right: 10px; height: 200px; background-color: grey; float:right; margin-top: 10px;">
	        <p>Rate of Courier Delivery = Mode of Transport + Weight of courier + Distance Travelled * Number of Courier Packages</p>
	...
	<a class="txt1" href="login1.php#home" ><i class="fa fa-arrow-left"></i>	Back</a>
</div>
