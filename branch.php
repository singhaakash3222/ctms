    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-th-list"></i> View Branches</h2>
            ...
            <div class="box-content">
                <!-- Start content here -->
					...
					<div class="alert alert-info">
						                          ...
						                          <a class="btn btn-success" href="add_branch.php<?php echo '?
                            id='.$ID; ?>">
                                <i >Add Branches</i>
                            </a>
...
$row=mysqli_fetch_array($query);
  ?>					
            ...
            <th>action</th>
					...
					<tbody>
							<?php
							$result= mysqli_query($con,"SELECT * FROM `branch` WHERE `cityid`='$ID'") or die (mysqli_error());
					...
					?>
					   <td><?php echo $row['bid']; ?></td>
						...
						<td class="center">
							...
							<?php include('modal_delete_branch.php'); ?>
						</td>
					</tr>
							<?php } ?>
					</tbody>
