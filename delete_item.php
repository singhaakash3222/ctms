    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="alert alert-danger">
				Are you sure you want to delete courier<span class="label-primary label label-default"><?php echo $row['name']; ?></span> ?
			</div>
			<div class="modal-footer">
			<button class="btn btn-inverse" data-dismiss="modal" ><i class="glyphicon glyphicon-remove icon-white"></i> No</button>
