...
<h2 align="right"><a href="employee.php" class="slider_nav_btn home_btn" align><i  class="fa fa-home">Home</i> </a></h2>
</div>
			<div class="body">
            <h3>Add Courier</h3>
                ...
                <form action="add.php" method="post" name="frmShipment" >
                ...
                <table border="0" cellpadding="0" cellspacing="0" align="center" width="75%">
                  <tbody>
                    <tr>
                      ...
                      <td width="16">&nbsp;</td>
                      <td width="339">
                        <input name="iname"  maxlength="100" size="40" type="TEXT" required=""> </td>
                   </tr>
                  <tr>
                   ...
                   <tr>
                      ...
                      <td width="339">
                        <input name="sname"  maxlength="100" size="40" type="TEXT" required=""> </td>
                          ...
                          <tr>
                            <td class="TrackMediumBlue" align="right">Origin state   :</td>
                            <td>&nbsp;</td>
                            <td><input name="origs" id="orig" maxlength="13" size="40" type="TEXT" required=""></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td class="TrackMediumBlue" align="right">Mobile :</td>
                            <td>&nbsp;</td>
                            <td><span class="REDLink">
                              <input name="smob" cols="27" type="text" rows="2" maxlength="10" minlength="10"  required="">
                              </span></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td class="TrackMediumBlue" align="right">Destination state : </td>
                            <td>&nbsp;</td>
                            <td><input name="dests" id="dest" maxlength="13" size="40" type="TEXT" required=""></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td class="TrackMediumBlue" align="right">Reciever Mobile :</td>
                            <td>&nbsp;</td>
                            <td><span class="REDLink">
                              <input name="rnum" cols="27" type="text" rows="2" maxlength="10" minlength="10"   required="">
                              </span></td>
                          </tr>
                          <tr>
                            <td class="TrackMediumBlue" align="right">&nbsp;</td>
                          ...
                          <tr>
                            ...
                            <td>&nbsp;</td>
                            <td><select id="distance"  name="dis" required="">
