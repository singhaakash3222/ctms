    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-info-sign"></i> All Delivered Courier Orders</h2>
...
<form method="POST" action="release_query.php">
           ...
           <th>Status</th>
            <th>action</th>
					...
					<tbody>
							<?php
							$result= mysqli_query($con,"SELECT * FROM `courier_table` WHERE `status` = 'delivered'") or die (mysqli_error());
					...
					?>
						...
						<td class="center">
							...
							<a class="btn btn-success" href="edit_courier3.php<?php echo '?cid='.$id; ?>">
              ...
              <a class="btn btn-primary" href="invoice.php<?php echo '?cid='.$id; ?>">
                <i class="glyphicon  glyphicon-download-alt"></i>
							...
							<?php include('modal_delete_delivered.php'); ?>
						</td>
					</tr>
							<?php } ?>
					</tbody>
