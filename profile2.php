...
<div class="row">
<label>Country:</label><br/>
<select name="country" id="country-list" class="demoInputBox" onChange="getState2(this.value);">
<option value disabled selected>Select Country</option>
<?php
foreach($results as $country) {
?>
...
<div class="row">
<label>State:</label><br/>
<select name="state" id="state-list2" class="demoInputBox" onChange="getCity2(this.value);">
<option value="">Select State</option>
</select>
</div>
<div class="row">
<label>City:</label><br/>
<select name="city" id="city-list2" class="demoInputBox">
<option value="">Select City</option>
</select>
</div>
</div>
