...
<h2 align="center"><a href="addc.php">Add </a>and View Courier&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="employee.php" class="slider_nav_btn home_btn" align><i  class="fa fa-home">Home</i> </a>
			...
			<div class="body">
                ...
                <form action="viewcourier1.php" method="post" name="frmShipment" >
                ...
                <table border="0" cellpadding="0" cellspacing="0" align="center" width="75%">
                  ...
                  <tr>
                   ...
                   <tr>
                      ...
                      <td width="16">&nbsp;</td>
                      <td width="339">
                        <input name="sname"  maxlength="100" size="40" type="TEXT" > </td><td><input align="right" name="pay" type="submit" value="View Courier" /></td>
                   </tr>
