...
<body>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
          ...
          <tbody>
              <?php
              $result= mysqli_query($con,"SELECT * FROM `tbl_order_items` order BY `order_id` ASC ") or die (mysqli_error());
          ...
          <tr>
            ...
            <td class="center">
              ...
              <a class="btn btn-success" href="update_courier.php<?php echo '?cid='.$id; ?>">
              ...
              <?php include('modal_delete_courier1.php'); ?>
            </td>
          </tr>
              <?php } ?>
          </tbody>
