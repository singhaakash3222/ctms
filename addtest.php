...
$query12=mysqli_query($con,"select * from employee where emp_id='$emp'")or die(mysqli_error());
...
if(!$result)
  { 
    ...
    $query="select * from courier_table order by cid desc limit 2 ";
$result=mysqli_query($con,$query);
  $row=mysqli_fetch_array($result);
        
      echo "<table>
      <tr>
           <th>Courier id for Future purpose</th>
           <th>Item name:-</th>
           <th>Sname:-</th>
...

      {
        ...
        echo "<tr>";
                ...
                echo "<td>" . $row['orig_state'] . "</td>";
                echo "<td>" . $row['rname'] . "</td>";
                echo "<td>" . $row['dest_state'] . "</td>";
                echo "<td>" . $row['radd'] . "</td>";
                echo "<td>" . $row['date'] . "</td>";
                echo "<td>" . $row['mode'] . "</td>";
