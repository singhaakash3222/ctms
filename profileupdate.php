...
$uname=$row['username'];
  ?>					
					<form method="POST" enctype="multipart/form-data" class="form-horizontal" style="margin-left:250px;">
						<input type="hidden" name="cid" value="<?php echo $row['cid']; ?>" class="form-control" id="inputEmail3" placeholder="Firstname....." required />
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-4">
						  <input type="text" name="mobile" value="<?php echo $row['mobile']; ?>" class="form-control" id="inputPassword3" placeholder="Lastname....." required />
						</div>
					  </div>
					  <div class="form-group">
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-4">
						  <input type="text" name="username" value="<?php echo $row['username']; ?>" class="form-control" id="inputPassword3" placeholder="Password....." disabled />
						</div>
					  </div>
					  <div class="form-group">
...
mysqli_query($con,"UPDATE `client` SET `username`='$uname',`password`='$password',`name`='$name',`emailid`='$email',`mobile`='$mobile',`address`='$address',`city`='$city',`country`='$country 'WHERE `cid` = '$id' ")or die(mysqli_error($con));
