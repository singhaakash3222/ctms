...
<body>
<form name="reg" action='insert1.php'  method='post'>
<table align="center">
	<tr>
...
<td><select name="city3" style="width: 240px" id="city-list3" onChange="getbranch(this.value);" >
...
<td><select name="branch" style="width: 240px" id="branch-list3" >
