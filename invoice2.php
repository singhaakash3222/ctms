...
$pdf->Cell(180,5,'SoftEx Courier Tax Detail',0,1,'R');
...
$pdf->SetX(155);
$pdf->Cell(30,6,'Revenue ',1,0,'L');
$pdf->SetX(185);
$pdf->Cell(20,6,'Total Tax',1,0,'L');
$pdf->Ln();
...
$pdf->SetY($Y_Table_Position);
$pdf->SetX(155);
$pdf->MultiCell(30,6,$rate1,1,2,'L');

$pdf->SetY($Y_Table_Position);
$pdf->SetX(185);
$pdf->MultiCell(20,6,$tax,1,2,'L');
$pdf->Cell(1 ,2,'',0,2);
...
$pdf->SetFont('Arial','B',14);
$pdf->Cell(180,5,'Total Tax Amount:-',0,0,'R');
$pdf->SetFont('Arial','B',14);
